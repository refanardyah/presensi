(function ($) {
  ...
  $container.append(
    '<h5>Sesuaikan Tampilan</h5><hr class="mb-2"/>'
    + '<h6>Warna Navbar</h6>'
  )
  ...
  $checkbox_container.append('<span>Garis navbar</span>')
  ...
  $container.append('<h6>Warna Sidebar Gelap</h6>')
  ...
  $container.append('<h6>Warna Sidebar Terang</h6>')
  var $sidebar_variants = $('<div />', {
    'class': 'd-flex'
  })
  $container.append($sidebar_variants)
  ...
  $container.append('<h6>Warna Background Logo</h6>')
